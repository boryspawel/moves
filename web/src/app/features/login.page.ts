...
@Component({
  ...
  template: `
    <mat-card class="panel">
      ...
      <mat-card-actions>
        <button mat-flat-button type="button" (click)="login()">Przejdź do logowania</button>
        <button mat-stroked-button type="button" (click)="register()">Utwórz konto</button>
      </mat-card-actions>
    </mat-card>
  `,
...
export class LoginPage {
  ...
  protected register(): void { void this.auth.register(); }
}
