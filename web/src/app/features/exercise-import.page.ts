    ...
    <section class="panel import-page">
      ...
      @if (batch(); as current) {
        <mat-card><mat-card-content>
          ...
          @if (!isProcessing(current) && current.draftedCount > 0) { <a mat-flat-button [routerLink]="['/admin/exercise-review']" [queryParams]="{batchId: current.id}">Zobacz utworzone szkice</a> }
