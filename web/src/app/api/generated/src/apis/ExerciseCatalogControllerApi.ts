...
export class ExerciseCatalogControllerApi extends runtime.BaseAPI {
     ...
     */
    async listRaw(requestParameters: ListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CatalogPage>> {
     ...
     * Search published exercise versions using explicitly allowed filters
     */
    async list(requestParameters: ListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CatalogPage> {
     ...
     */
    async versionRaw(requestParameters: VersionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExerciseCatalogDetailView>> {
        const requestOptions = await this.versionRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ExerciseCatalogDetailViewFromJSON(jsonValue));
    }

    /**
     * Read a public detail projection of one published exercise version
     */
    async version(requestParameters: VersionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExerciseCatalogDetailView> {
