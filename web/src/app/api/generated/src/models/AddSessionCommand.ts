...
export function AddSessionCommandFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddSessionCommand {
    if (json == null) {
        return json;
    }
    return {
...
export function AddSessionCommandToJSONTyped(value?: AddSessionCommand | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
