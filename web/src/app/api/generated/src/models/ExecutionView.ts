...
export function ExecutionViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExecutionView {
    ...
    return {
        ...
        'safetyAlerts': json['safetyAlerts'] == null ? undefined : ((json['safetyAlerts'] as Array<any>).map(AlertDataFromJSON)),
    };
}
...
export function ExecutionViewToJSONTyped(value?: ExecutionView | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'alerts': value['alerts'],
        'safetyAlerts': value['safetyAlerts'] == null ? undefined : ((value['safetyAlerts'] as Array<any>).map(AlertDataToJSON)),
    };
}
