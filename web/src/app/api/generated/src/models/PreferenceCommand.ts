...
export function PreferenceCommandFromJSONTyped(json: any, ignoreDiscriminator: boolean): PreferenceCommand {
    if (json == null) {
        return json;
    }
    return {
...
export function PreferenceCommandToJSONTyped(value?: PreferenceCommand | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
