...
export function JsonNodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): JsonNode {
    ...
    return {
        ...
        'floatingPointNumber': json['floatingPointNumber'] == null ? undefined : json['floatingPointNumber'],
...
export function JsonNodeToJSONTyped(value?: JsonNode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
