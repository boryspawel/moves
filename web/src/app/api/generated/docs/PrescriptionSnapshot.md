...
```typescript
import type { PrescriptionSnapshot } from '@moves/api-client';
...
const example = {
  ...
  notes: null,
} satisfies PrescriptionSnapshot;
...
const exampleParsed = JSON.parse(exampleJSON) as PrescriptionSnapshot;
