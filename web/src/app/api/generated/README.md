...
| _AnatomyReferenceAdminControllerApi_ | [**get**](docs/AnatomyReferenceAdminControllerApi.md#get)                                              | **GET** /api/v1/admin/anatomical-structures/{structureId}                                                    |
| _AnatomyReferenceAdminControllerApi_ | [**publish1**](docs/AnatomyReferenceAdminControllerApi.md#publish1)                                    | **POST** /api/v1/admin/anatomical-structures/{structureId}/publish                                           | Publish an immutable anatomical structure                                     |
...
| _ExerciseCatalogControllerApi_       | [**version**](docs/ExerciseCatalogControllerApi.md#version)                                            | **GET** /api/v1/exercises/versions/{versionId}                                                               |
...
| _GamificationControllerApi_          | [**progress**](docs/GamificationControllerApi.md#progress)                                             | **GET** /api/v1/gamification/me                                                                              | Return private points and a non-medical ledger view                           |
...
- [ContributionSnapshot](docs/ContributionSnapshot.md)
...
- [EvidenceSnapshot](docs/EvidenceSnapshot.md)
...
- [LoadCharacteristicSnapshot](docs/LoadCharacteristicSnapshot.md)
...
- [PublishedExerciseVersionSnapshot](docs/PublishedExerciseVersionSnapshot.md)
