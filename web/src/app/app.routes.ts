...
export const routes: Routes = [
  ...
  { path: 'specialist/clients/:participantId/plans', data: { plansIndex: true }, canActivate: [authGuard, completedOnboardingGuard, roleGuard('SPECIALIST')], loadComponent: () => import('./features/specialist-plan.page').then(m => m.SpecialistPlanPage) },
  { path: 'specialist/clients/:participantId/plans/new', canActivate: [authGuard, completedOnboardingGuard, roleGuard('SPECIALIST')], loadComponent: () => import('./features/specialist-plan.page').then(m => m.SpecialistPlanPage) },
  ...
  { path: 'my-plans', data: { plansIndex: true, plannerActor: 'PARTICIPANT' }, canActivate: [authGuard, completedOnboardingGuard, roleGuard('PARTICIPANT')], loadComponent: () => import('./features/specialist-plan.page').then(m => m.SpecialistPlanPage) },
  { path: 'my-plans/new', data: { plannerActor: 'PARTICIPANT' }, canActivate: [authGuard, completedOnboardingGuard, roleGuard('PARTICIPANT')], loadComponent: () => import('./features/specialist-plan.page').then(m => m.SpecialistPlanPage) },
  { path: 'my-plans/:planId', data: { plannerActor: 'PARTICIPANT' }, canActivate: [authGuard, completedOnboardingGuard, roleGuard('PARTICIPANT')], loadComponent: () => import('./features/specialist-plan.page').then(m => m.SpecialistPlanPage) },
  { path: 'my-plans/:planId/revisions/:revisionId', data: { plannerActor: 'PARTICIPANT' }, canActivate: [authGuard, completedOnboardingGuard, roleGuard('PARTICIPANT')], loadComponent: () => import('./features/specialist-plan.page').then(m => m.SpecialistPlanPage) },
  { path: 'my-exercise-sets', canActivate: [authGuard, completedOnboardingGuard, roleGuard('PARTICIPANT')], loadComponent: () => import('./features/participant-exercise-set-library.page').then(m => m.ParticipantExerciseSetLibraryPage) },
  { path: 'my-exercise-sets/:versionId', canActivate: [authGuard, completedOnboardingGuard, roleGuard('PARTICIPANT')], loadComponent: () => import('./features/participant-exercise-set-detail.page').then(m => m.ParticipantExerciseSetDetailPage) },
  ...
  { path: 'progress', canActivate: [authGuard, completedOnboardingGuard, roleGuard('PARTICIPANT')], loadComponent: () => import('./features/participant-progress.page').then(m => m.ParticipantProgressPage) },
