...
public class ExerciseSetController {
    ...
    @PostMapping("/{setId}/versions/{versionId}/grants") public void grant(@AuthenticationPrincipal Jwt jwt, @PathVariable UUID setId, @PathVariable UUID versionId, @Valid @RequestBody GrantRequest request) { service.grant(jwt.getSubject(), setId, versionId, request); }
    @DeleteMapping("/{setId}/versions/{versionId}/grants/{participantId}") public void revoke(@AuthenticationPrincipal Jwt jwt, @PathVariable UUID setId, @PathVariable UUID versionId, @PathVariable UUID participantId) { service.revoke(jwt.getSubject(), setId, versionId, participantId); }
    @GetMapping("/{setId}/versions/{versionId}/grants") public List<GrantRecipientView> grants(@AuthenticationPrincipal Jwt jwt, @PathVariable UUID setId, @PathVariable UUID versionId) { return service.grantRecipients(jwt.getSubject(), setId, versionId); }
}
