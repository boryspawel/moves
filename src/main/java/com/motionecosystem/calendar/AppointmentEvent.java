...
class AppointmentEvent {
    ...
    @Enumerated(EnumType.STRING) @Column(name = "event_type", nullable = false, length = 64) Type eventType;
    @Enumerated(EnumType.STRING) @Column(name = "from_status", length = 64) Appointment.Status fromStatus;
    @Enumerated(EnumType.STRING) @Column(name = "to_status", nullable = false, length = 64) Appointment.Status toStatus;
    ...
    @Enumerated(EnumType.STRING) @Column(name = "type", nullable = false, length = 64) Appointment.Type type;
    @Enumerated(EnumType.STRING) @Column(name = "location_mode", nullable = false, length = 64) Appointment.LocationMode locationMode;
